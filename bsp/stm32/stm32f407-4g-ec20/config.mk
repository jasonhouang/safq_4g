BSP_ROOT ?= E:/safq/rt-thread/bsp/stm32/stm32f407-4g-ec20
RTT_ROOT ?= E:/safq/rt-thread

CROSS_COMPILE ?=D:\\Tools\\env_released_1.1.3\\env\\tools\\gnu_gcc\\arm_gcc\\mingw\\bin\\arm-none-eabi-
...
CPPPATHS :=-I$(RTT_ROOT)\bsp\stm32\libraries\HAL_Drivers \
	...
	-I$(BSP_ROOT)\applications\dev_model \
	-I$(BSP_ROOT)\board \
	...
	-I$(BSP_ROOT)\packages\cJSON-latest \
